...
const translations = {
  es: {
    ...
    title_bio: "Hola, mi nombre es Ron y soy amante de la tecnología y el aprendizaje constante",
    ...
    about_p2: 'Me gradué como Ingeniero Ambiental y cuento con 10 años de experiencia laboral en el sector público, privado y cooperación internacional en roles relacionados con gestión medio ambiental, desarrollo sostenible, gestión empresarial y emprendedurismo. En 2022 fundé el emprendimiento "The Party Wagon" y en 2023 una escula de Programación para niños "Algorithmics School-Chinandega Branch".',
    // Skills & Hobbies
    skills_title: "Skills",
    hobbies_title: "Hobbies",
    // Formación Académica
    academic_title: "Formación académica",
    academic_course1_title: "Análisis de datos",
    academic_course2_title: "Formación en UX Design",
    academic_course3_title: "Posgrado en diseño",
    academic_course3_subtitle: "En curso - UFRJ",
  ...
  en: {
    ...
    title_bio: "Hello, my name is Ron and I love technology and constant learning",
